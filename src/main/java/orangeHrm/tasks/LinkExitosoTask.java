...
public class LinkExitosoTask implements Task {

    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo( Enter.theValue("Admin").into(USERNAME_FIELD));
        actor.attemptsTo( Enter.theValue("admin123").into(INPUT_CLAVE));
